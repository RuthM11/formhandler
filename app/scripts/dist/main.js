...
var FormHandler = exports.FormHandler = function () {
  function FormHandler(selector) {
    ...
    this.$form = (0, _jquery2.default)(selector);
    if (this.$form === 0) {
